...
<body>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="border: 1px solid #a1a1a1;">
            <h1 class="text-primary" style="text-align: center;">Barcode Generator</h1>
        </div>
    </div>
    ...
    <div class="container text-center" style="padding: 15px;width: 70%;">
        ...
        <br/>
        <br/>
        <img src="data:image/png;base64,{{DNS2D::getBarcodePNG('hello, i am Touhid.', 'QRCODE',10,10)}}" alt="barcode" />
    </div>
